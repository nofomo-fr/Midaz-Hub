...
local slowed = dropdown:Add("Slowed")
local mars = dropdown:Add("Normal")
local medium = dropdown:Add("Medium")
local fast = dropdown:Add("Fast")
local earth = dropdown:Add("Fastest")
    ...
    task.spawn(function()
        while AutoPunching do
            ...
            if punchTool then
                ...
                if attackTime then
                    if SelectedPunchVersion == "Slowed" then
                        attackTime.Value = 1.0 -- slowest
                    elseif SelectedPunchVersion == "Normal" then
                        attackTime.Value = 0.35
                    elseif SelectedPunchVersion == "Medium" then
                        attackTime.Value = 0.2
                    elseif SelectedPunchVersion == "Fast" then
                        attackTime.Value = 0.1
                    elseif SelectedPunchVersion == "Fastest" then
                        attackTime.Value = 0 -- fastest
                    end
                end
